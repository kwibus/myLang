...
fixInfix1 (e:es) [] [o] = 
    fixInfix1 (e:es) [Lambda "#" (Appl o (Var "#"))] []
...
unwindStacks [] os = (os, [])
unwindStacks vs [] = (vs, [])
unwindStacks (v1:v2:vs) (o:os) = uncurry unwindStacks ((Appl (Appl o v2) v1):vs,os)
unwindStacks (v:vs) (o:os) = ((Appl o v) :vs,os)

getpres::  LamTerm Vallue n -> (Precedence , Associativity)
getpres (Val BuildIn{fixity=InFix p a}) = (p,a)
getpres _ = error "no infix"

--TODO correct associative
higer :: [LamTerm Vallue n] -> LamTerm Vallue n -> Bool
higer [] _ = True
